...
const devto = () => {
  ...
  readFile(fileName, 'utf8', (err, content) => {
    ...
    parsedContent = parsedContent.replace(
      CLOUDINARY_REGEXP,
      '![$2](https://res.cloudinary.com/tatran/image/upload/q_auto,f_auto/$1)'
    );
    parsedContent = parsedContent.replace(
      GITHUB_REGEXP,
      '{% github $1 no-readme %}'
...
const getOgImage = () => {
  readFile(fileName, 'utf8', (err, content) => {
    ...
    const bannerLink = `https://res.cloudinary.com/tatran/image/upload/f_auto,c_fill,ar_4:5,w_1200/banner/logo/${frontmatter.banner}`;
